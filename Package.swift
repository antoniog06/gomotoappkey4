...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/googlemaps/google-maps-ios-utils.git", from: "4.1.6"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "GoogleMaps", package: "google-maps-ios-sdk"),   // ✅ Added
                .product(name: "GooglePlaces", package: "google-maps-ios-sdk"), // ✅ Added
